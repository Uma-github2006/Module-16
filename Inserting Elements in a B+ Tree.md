...
## OUTPUT
![image](https://github.com/user-attachments/assets/96fde316-b13a-481a-8a31-9718fa109828)


## RESULT
Thus the Python function `def insert(self, key, value):` to insert elements into a B+ Tree is implemented and executed successfully.
