# Ex. No: 16E -  Perform left rotation operation in python. Get the value 'n' from the user and insert in an AVL tree.

## AIM:
To write a Python function `def leftRotate(self, z):` to perform the left rotation operation in an AVL Tree and get the value 'n' from the user and insert in an AVL tree.
...
### Step 6: Insert the key value using the `insert()` method. If it causes imbalance, perform appropriate rotation.
...
## OUTPUT
![image](https://github.com/user-attachments/assets/4882fb6d-75de-4693-9e39-64755cf85dbf)


## RESULT
Thus the python program to perform left rotation operation is implemented and executed
successfully.
