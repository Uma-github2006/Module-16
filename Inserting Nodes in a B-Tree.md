...
## OUTPUT
![image](https://github.com/user-attachments/assets/26e15a87-11b5-4949-a49f-4db8ba9a0b9a)


## RESULT
Thus the Python function `def insert(self, k):` to insert the nodes in a B-Tree is implemented and excecuted successfully.
